...
export const UserCrud = () => {
    ...
    const createUser = async () => {
        ...
        .post('http://192.168.137.49:8080/user', 
        {
            typeUser: 1,
            name, 
            email,
    ...
    const handleOnChangePhone = (event: NativeSyntheticEvent<TextInputChangeEventData>) => {
    ...
    const handleOnChangeCpf = (event: NativeSyntheticEvent<TextInputChangeEventData>) => {
